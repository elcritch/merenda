...
- Run tests through Atlas: `atlas-run tests [test-selections]`. Omit selections to run the full suite, or pass one or more test selectors/files to run focused tests.
...
- Run a single test locally:
  ...
  - `atlas-run tests tests/ttransfer.nim --compile-only`
