...
- Files: `IBMPlexSans-Regular.ttf`, `IBMPlexSans-Italic.ttf`, `IBMPlexSans-Bold.ttf`.
...
- File: `JetBrainsMonoNerdFontMono-Regular.ttf` (distributed as a ZIP resource).
- Base font: JetBrains Mono 2.304.
- Copyright 2020 The JetBrains Mono Project Authors.
- Base license: SIL Open Font License 1.1, with no Reserved Font Names declared.
- Complete license: `font-licenses/JetBrainsMono-OFL.txt`.
- Source: <https://github.com/JetBrains/JetBrainsMono>.
- Nerd Fonts patch version: 3.5.1.
- Patch sources and glyph notices:
  <https://github.com/ryanoasis/nerd-fonts/tree/v3.5.1>.
