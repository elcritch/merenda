...
- Avoid subclass checks in shared control flow when behavior belongs to a specific document or widget. Prefer a narrow callback or protocol hook; use a type check when the behavior truly depends on the concrete type.
