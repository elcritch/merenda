...
requires "siwin#requires "crunchy >= 0.1.11"
requires "gh:elcritch/siwin >= 1.1.1"
requires "gh:elcritch/figdraw >= 0.36.0 [siwin, sharedlib, harfbuzz]"
...
feature "kosmo":
  requires "gh:elcritch/moe#d230e3faf84d"
